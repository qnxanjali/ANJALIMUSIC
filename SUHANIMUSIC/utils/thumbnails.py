...
async def gen_thumb(videoid: str):
    try:
        ...
        title_font = ImageFont.truetype("SUHANIMUSIC/assets/font3.ttf", 45)
        ...
        draw.text((10, 10), f"ANJALI MUSIC", fill="yellow", font=font)
        ...
        play_icons = Image.open("SUHANIMUSIC/assets/play_icons.png")
